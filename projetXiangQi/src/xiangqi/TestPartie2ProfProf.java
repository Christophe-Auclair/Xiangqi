...
public class TestPartie2ProfProf {
    ...
    Roi rRouge, rNoir, rNoir2;
    Char tRouge, tRouge2, tNoir, tNoir2;
    ...
    public void initialisation() {
        ...
        tNoir2 = new Char("t2", "noir");
        e.getIntersection(0, 8).setPiece(tNoir2);

        rNoir2 = new Roi("r2", "noir");
        e.getIntersection(0, 4).setPiece(rNoir2);
